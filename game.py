...
class Game:
    ...
    def print_board(self):
        print("%s --------- %s --------- %s     0 ----------- 1 ------------ 2" % (self.board[0].hold_str(), self.board[1].hold_str(), self.board[2].hold_str()))
        print("|           |           |     |             |              |")
        print("|   %s ----- %s ----- %s   |     |   3 ------- 4 ------- 5    |" % (self.board[3].hold_str(), self.board[4].hold_str(), self.board[5].hold_str()))
        print("|   |       |       |   |     |   |         |         |    |")
        print("|   |   %s - %s - %s   |   |     |   |    6 -- 7 -- 8    |    |" % (self.board[6].hold_str(), self.board[7].hold_str(), self.board[8].hold_str()))
        print("|   |   |       |   |   |     |   |    |         |    |    |")
        print("%s - %s - %s       %s - %s - %s     9 - 10 - 11        12 - 13 - 14" % (self.board[9].hold_str(), self.board[10].hold_str(), self.board[11].hold_str(), self.board[12].hold_str(), self.board[13].hold_str(), self.board[14].hold_str()))
        print("|   |   |       |   |   |     |   |    |         |    |    |")
        print("|   |   %s - %s - %s   |   |     |   |    15 - 16 - 17   |    |"  % (self.board[15].hold_str(), self.board[16].hold_str(), self.board[17].hold_str()))
        print("|   |       |       |   |     |   |         |         |    |")
        print("|   %s ----- %s ----- %s   |     |   18 ------ 19 ------ 20   |" % (self.board[18].hold_str(), self.board[19].hold_str(), self.board[20].hold_str()))
        print("|           |           |     |             |              |")
        print("%s --------- %s --------- %s     21 ---------- 22 ----------- 23" % (self.board[21].hold_str(), self.board[22].hold_str(), self.board[23].hold_str()))
